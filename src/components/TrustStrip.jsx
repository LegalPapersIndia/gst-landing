...
//           <h2 className="mt-2 font-display text-3xl text-navy-600 sm:text-4xl">
...
//                 <p className="mt-3 font-mono text-2xl font-bold text-navy-900 sm:text-3xl">
//                   {s.value}
//                 </p>

//                 <p className="mt-2 font-display text-sm font-medium text-black sm:text-base">
//   {s.label}
// </p>
