...
//                 className="group relative flex gap-4 overflow-hidden rounded-2xl border border-transparent bg-navy-600 p-6 shadow-[0_20px_45px_-25px_rgba(10,20,40,0.5)] transition-all duration-500 hover:-translate-y-1.5 hover:border-gold-500/40 hover:bg-white hover:shadow-[0_25px_55px_-25px_rgba(10,20,40,0.35)] sm:p-7"
//               >
//                 {/* Dotted texture, fades out on hover */}
//                 <div
...
//                 {/* Top-right glow, fades out on hover */}
...
//                 <span className="absolute inset-y-0 left-0 w-[3px] bg-gradient-to-b from-gold-500/0 via-gold-500/80 to-gold-500/0 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
...
//                     damping: 18,
//                   }}
//                   className="absolute right-5 top-5 flex h-6 w-6 items-center justify-center rounded-full bg-gold-500/15 ring-1 ring-gold-500/40 transition-colors duration-500 group-hover:bg-gold-500/10"
//                 >
//                   <Check className="h-3.5 w-3.5 text-gold-400 transition-colors duration-500 group-hover:text-gold-600" strokeWidth={3} />
//                 </motion.div>
...
//                     <div className="relative flex h-12 w-12 items-center justify-center rounded-full bg-gold-500/10 ring-1 ring-gold-500/20 transition-all duration-500 group-hover:bg-gold-500 group-hover:ring-gold-500">
//                       <Icon className="h-5 w-5 text-gold-400 transition-colors duration-500 group-hover:text-white" />
//                     </div>
//                   </div>

//                   <div className="pr-6">
//                     <p className="font-display text-lg font-bold text-white transition-colors duration-500 group-hover:text-black sm:text-xl">
//                       {item.title}
//                     </p>

//                     <p className="mt-2 text-base leading-relaxed text-white/65 transition-colors duration-500 group-hover:text-slate-800 sm:text-[17px]">
//                       {item.desc}
//                     </p>
//                   </div>
//                 </div>
...
// // import lpiMascot from "../assets/hero-gst-form (3).png";
...
//                       delay: i * 0.1,
//                     }}
//                     className="group relative overflow-hidden rounded-2xl border border-transparent bg-navy-600 p-6 text-center shadow-[0_20px_45px_-25px_rgba(10,20,40,0.5)] transition-all duration-500 hover:-translate-y-2 hover:border-gold-500/40 hover:bg-white hover:shadow-[0_25px_55px_-25px_rgba(10,20,40,0.35)] sm:p-7"
//                   >
//                     {/* ================= DOTTED TEXTURE ================= */}
...
//                     <div className="pointer-events-none absolute -bottom-16 -left-16 h-32 w-32 rounded-full bg-blue-400/10 blur-2xl" />
...
//                         damping: 18,
//                       }}
//                       className="absolute right-4 top-4 flex h-6 w-6 items-center justify-center rounded-full bg-gold-500/15 ring-1 ring-gold-500/40 transition-colors duration-500 group-hover:bg-gold-500/10"
//                     >
//                       <Check
//                         className="h-3.5 w-3.5 text-gold-400 transition-colors duration-500 group-hover:text-gold-600"
//                         strokeWidth={3}
//                       />
//                     </motion.div>
...
//                         <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gold-500/10 ring-1 ring-gold-500/20 transition-all duration-500 group-hover:bg-gold-500 group-hover:ring-gold-500">
//                           <Icon className="h-6 w-6 text-gold-400 transition-colors duration-500 group-hover:text-white" />
//                         </div>
//                       </div>
...
//                       <p className="mt-2 max-w-sm text-sm leading-relaxed text-white/65 transition-colors duration-500 group-hover:text-slate-800 sm:text-[16px]">
//                         {item.desc}
//                       </p>
//                     </div>
//                   </motion.div>
...
//             >
//               {/* <span className="inline-flex items-center rounded-full border border-blue-500/15 bg-blue-500/5 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-blue-700">
//                 GST Made Simple
//               </span> */}
//             </motion.div>
...
//                 Let our experts handle the process while you focus on growing
//                 your business.
//               </p> */}
//             </motion.div>
