...
// const platformTaglines = {
//   "Google Reviews": "Verified reviews from real GST clients",
//   Mouthshut: "Honest feedback from businesses like yours",
//   Trustpilot: "Independently verified customer ratings",
// };

// // Mouthshut in the middle, Google & Trustpilot on the sides
// const displayOrder = ["Google Reviews", "Mouthshut", "Trustpilot"];

// export default function Reviews() {
//   const orderedPlatforms = displayOrder
//     .map((name) => reviewPlatforms.find((r) => r.name === name))
//     .filter(Boolean);
...
//                 hover:shadow-[0_25px_50px_-25px_rgba(10,20,40,0.45)]
//               "
//             >
...
//                 alt={r.name}
//                 loading="lazy"
//                 className="relative z-10 h-16 w-auto max-w-[8rem] object-contain transition-transform duration-300 group-hover:scale-105 sm:h-20 sm:max-w-[9rem]"
//               />

//               <p className="relative z-10 mt-4 font-display text-xl font-bold text-black sm:text-2xl">
//                 {r.name}
//               </p>

//               <p className="relative z-10 mt-1.5 text-xs font-medium text-navy-900/60 sm:text-sm">
//                 {platformTaglines[r.name]}
//               </p>
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="relative z-10 mt-5 inline-flex items-center gap-1.5 rounded-full border border-gold-500/40 bg-gold-500/10 px-4 py-2 font-mono text-xs font-bold uppercase tracking-wider text-gold-600 transition-all duration-300 hover:gap-2.5 hover:bg-gold-500 hover:text-white"
//               >
//                 Read More
//                 <ArrowUpRight className="h-3.5 w-3.5 transition-transform duration-300" />
//               </a>
