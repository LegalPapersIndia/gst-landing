          ...
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Side icon badge — orange, bigger */}
                <div className="icon-pulse absolute left-4 top-4 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-orange-500 text-white shadow-md transition-transform duration-500 group-hover:scale-110">
                  <Icon className="h-5 w-5" />
                </div>

                {/* Tag */}
                {s.tag && (
                  <span className="absolute right-4 top-4 z-10 rounded-full bg-gold-100 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-gold-700">
                    {s.tag}
                  </span>
                )}

                {/* Image */}
                <div className="relative z-10 mt-1 flex h-36 items-center justify-center overflow-hidden">
                  <img
                    src={image}
                    alt={s.title}
                    loading="lazy"
                    className="h-36 w-36 object-contain transition-all duration-500 group-hover:scale-110"
                  />
                </div>

                {/* Title */}
                <h3 className="relative z-10 mt-1 text-lg font-bold transition-colors group-hover:text-gold-600">
                  {s.title}
                </h3>
